                                 ...
                                 <div class="col-sm-6 col-xl-3">
                                    <div class="media mg-t-20">
                                       ...
                                       <div>
                                          ...
                                          <h4 class="tx-20 tx-sm-18 tx-md-24 mg-b-0 tx-normal tx-rubik tx-dark">$<span class="counter">1,958</span><small class="tx-15">.50</small></h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-sm-6 col-xl-3">
                                    <div class="media mg-t-20">
                                       ...
                                       <div>
                                          ...
                                          <h4 class="tx-20 tx-sm-18 tx-md-24 mg-b-0 tx-normal tx-rubik tx-dark">$<span class="counter">9,234</span><small class="tx-15">.50</small></h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-sm-6 col-xl-3">
                                    <div class="media mg-t-20">
                                       ...
                                       <div>
                                          ...
                                          <h4 class="tx-20 tx-sm-18 tx-md-24 mg-b-0 tx-normal tx-rubik tx-dark">$<span class="counter">1,608</span><small class="tx-15">.50</small></h4>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-sm-6 col-xl-3">
                                    <div class="media mg-t-20">
                                       ...
                                       <div>
                                          ...
                                          <h4 class="tx-20 tx-sm-18 tx-md-24 mg-b-0 tx-normal tx-rubik tx-dark">$<span class="counter">6,820</span><small class="tx-15">.50</small></h4>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <table class="table table-hover mg-b-0">
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td class="tx-medium text-right tx-dark">$2,670<small class="tx-10">.50</small><span class="mg-l-5 tx-10 tx-normal tx-success"><i class="icon ion-md-arrow-up"></i>+ 5.5%</span></td>
                                       </tr>
                                       <tr>
                                          ...
                                          <td class="tx-medium text-right tx-dark">$6,930<small class="tx-10">.50</small><span class="mg-l-5 tx-10 tx-normal tx-danger"><i class="icon ion-md-arrow-down"></i>- 1.8%</span></td>
                                       </tr>
                                       <tr>
                                          <td class=" tx-normal tx-gray-600">03/04/2019</td>
                                          ...
                                          <td class="text-right">+ $3,065<small class="tx-10">.50</small></td>
                                          <td class="text-right">- $2,780<small class="tx-10">.50</small></td>
                                          <td class="tx-medium text-right tx-dark">$6,930<small class="tx-10">.50</small><span class="mg-l-5 tx-10 tx-normal tx-success"><i class="icon ion-md-arrow-down"></i>+ 0.8%</span></td>
                                       </tr>
                                       <tr>
                                          <td class=" tx-normal tx-gray-600">03/04/2019</td>
                                          ...
                                          <td class="text-right">- $2,780<small class="tx-10">.50</small></td>
                                          <td class="tx-medium text-right tx-dark">$2,930<small class="tx-10">.50</small><span class="mg-l-5 tx-10 tx-normal tx-danger"><i class="icon ion-md-arrow-down"></i>- 3.1%</span></td>
                                       </tr>
                                       <tr>
                                          <td class=" tx-normal tx-gray-600">03/04/2019</td>
                                          ...
                                          <td class="text-right">+ $1,065<small class="tx-10">.50</small></td>
                                          <td class="text-right">- $2,780<small class="tx-10">.50</small></td>
                                          <td class="tx-medium text-right tx-dark">$2,930<small class="tx-10">.50</small><span class="mg-l-5 tx-10 tx-normal tx-danger"><i class="icon ion-md-arrow-down"></i>- 0.2%</span></td>
                                       </tr>
                                    </tbody>
                                 </table>
                              </div>
                                    ...
                                    <table class="table table-hover mb-0">
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td class="tx-right"><span class="badge badge-outlined badge-success">Completed</span></td>
                                             <td class="tx-right"><i class="fa fa-check mr-1 text-success"></i> In Stock</td>
                                          </tr>
                                          <tr>
                                             ...
                                             <td class="tx-right"><span class="badge badge-outlined badge-warning">Pending</span></td>
                                             <td class="tx-right"><i class="fa fa-check text-success"></i> In Stock</td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                             ...
                                             <td class="tx-right"><span class="badge badge-outlined badge-danger">Out of stock</span></td>
                                             <td class="tx-right"> <i class="fa fa-exclamation-triangle text-danger"></i> Out of stock </td>
                                          </tr>
                                          <tr class="mb-0">
                           ...
                           <div class="col-lg-6 col-xl-12">
                              <div class="card mg-b-20">
                                 <div class="card-body">
                                    ...
                                    <p class="tx-12 mg-b-15 tx-gray-600">Lorem ipsum dolor sit amet, consectetur sed do eiusmod tempor incididunt ut labore et dolore. <a href="">Learn More</a></p>
                                    <div class="row">
                                       <div class="col-6 col-xl-6 d-sm-flex align-items-center">
                                          <div class="media mg-t-10">
                                             ...
                                             <div>
                                                ...
                                                <h4 class="tx-20 tx-sm-18 tx-md-24 mg-b-0 tx-normal tx-rubik tx-dark">45.90<small class="tx-15">%</small></h4>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="col-6 col-xl-6 d-sm-flex align-items-center">
                                          <div class="media mg-t-10">
                                             ...
                                             <div>
                                                ...
                                                <h4 class="tx-20 tx-sm-18 tx-md-24 mg-b-0 tx-normal tx-rubik tx-dark">4.32<small class="tx-15">min</small></h4>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                       ...
                                       <div class="col-6 d-sm-flex align-items-center">
                                          <div class="media mg-t-10">
                                             ...
                                             <div>
                                                ...
                                                <h4 class="tx-20 tx-sm-18 tx-md-24 mg-b-0 tx-normal tx-rubik tx-dark">49.38<small class="tx-15">%</small></h4>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="col-6 d-sm-flex align-items-center">
                                          <div class="media mg-t-10">
                                             ...
                                             <div>
                                                ...
                                                <h4 class="tx-20 tx-sm-18 tx-md-24 mg-b-0 tx-normal tx-rubik tx-dark">5,338<small class="tx-15">k</small></h4>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                     ...
                     <div class="col-md-12 col-xl-8">
                        <div class="card mg-b-20">
                           <div class="card-header">
                              ...
                              <div class="card-header-btn">
                                 <a  href="#" data-toggle="collapse" class="btn card-collapse" data-target="#customarDetails" aria-expanded="true"><i class="ion-ios-arrow-down"></i></a>
                                 <a href="#" data-toggle="refresh" class="btn card-refresh"><i class="ion-android-refresh"></i></a>
                                 <a href="#" data-toggle="expand" class="btn card-expand"><i class="ion-android-expand"></i></a>
                                 <a href="#" data-toggle="remove" class="btn card-remove"><i class="ion-ios-trash-outline"></i></a>
                              </div>
