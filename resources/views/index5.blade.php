                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             <div class="clearfix">
                                                ...
                                                <div class="float-right"> <small class="tx-gray-500">Mar 01, 2018 - Sep 30, 2019</small> </div>
                                             </div>
                                             <div class="progress ht-3 op-5">
                                          ...
                                          <td>$26,908</td>
                                          <td class="text-right"> <a href="" class="btn btn-label-primary btn-sm mg-y-5"><i class="fa fa-pencil"></i> Edit</a> <a href="" class="btn btn-label-success btn-sm mg-y-5"><i class="fa fa-link"></i> Add</a> <a href="" class="btn btn-label-danger btn-sm mg-y-5"><i class="fa fa-trash"></i> Delete</a> </td>
                                       </tr>
                                       <tr>
                                          <td><span >02</span></td>
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             <div class="clearfix">
                                                ...
                                                <div class="float-right"> <small class="tx-gray-500">Jun 09, 2018 - Oct 30, 2019</small> </div>
                                             </div>
                                             <div class="progress ht-3 op-5">
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             <div class="clearfix">
                                                ...
                                                <div class="float-right"> <small class="tx-gray-500">July 13, 2018 - Nov 20, 2019</small> </div>
                                             </div>
                                             <div class="progress ht-3 op-5">
                                          ...
                                          <td>$17,376</td>
                                          <td class="text-right text-white"> <a href="" class="btn btn-label-primary btn-sm mg-y-5"><i class="fa fa-pencil"></i> Edit</a> <a href="" class="btn btn-label-success btn-sm mg-y-5"><i class="fa fa-link"></i> Add</a> <a href="" class="btn btn-label-danger btn-sm mg-y-5"><i class="fa fa-trash"></i> Delete</a> </td>
                                       </tr>
                                       <tr>
                                          <td><span >05</span></td>
                                          ...
                                          <td>
                                             <div class="clearfix">
                                                ...
                                                <div class="float-right"> <small class="tx-gray-500">Aug 05, 2018 - Dec 21, 2019</small> </div>
                                             </div>
                                             <div class="progress ht-3 op-5">
